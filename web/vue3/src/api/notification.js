...
export default {
  mail(cb) { request.get('/api/system/mail').then(r => cb(r)) },
  ...
  feishu(cb) { request.get('/api/system/feishu').then(r => cb(r)) },
  ...
  wecom(cb) { request.get('/api/system/wecom').then(r => cb(r)) },
  ...
  webhook(cb) { request.get('/api/system/webhook').then(r => cb(r)) },
