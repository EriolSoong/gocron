<template>
  <div class="page"><div class="page-card" style="max-width:500px">
    <h2 style="margin-bottom:20px">修改我的密码</h2>
    <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
      <el-form-item label="新密码" prop="password"><el-input v-model="form.password" type="password" /></el-form-item>
      <el-form-item><el-button type="primary" @click="submit" :loading="submitting">保存</el-button><el-button @click="$router.push('/dashboard')">取消</el-button></el-form-item>
    </el-form>
  </div></div>
</template>
<script setup>
...
function submit() {
  formRef.value?.validate(v => {
    ...
    userService.editMyPassword(form.password, () => { ElMessage.success('修改成功'); router.push('/dashboard') })
  })
}
</script>
<style scoped>
